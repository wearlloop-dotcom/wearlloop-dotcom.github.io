...
(function () {
  ...
  const OPS_NAV = [
    ...
    { section: 'ธุรกิจ', items: [
      ...
      { href: 'accounting.html', label: 'บัญชี',         icon: '฿', roles: ['owner','manager','accounting'] },
      { href: 'slips.html',      label: 'สลิปโอน',       icon: '⊞', roles: ['owner','manager'] },
      { href: 'purchasing.html', label: 'จัดซื้อ',       icon: '⛬', roles: ['owner','manager','purchasing'] },
    ...
    { section: 'เจ้าของ', items: [
      { href: 'hr.html',        label: 'บุคคล (HR)',    icon: '☗', roles: ['owner','manager','hr_admin'] },
