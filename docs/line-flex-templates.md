...
### กล่อง "ข้อควรรู้" — remind กฎการเช่าเฉพาะที่เกี่ยวกับ step นั้น

ทุกกฎ**ดึงจากเงื่อนไขจริงใน `rental-terms.html`** (ห้ามแต่งใหม่) เขียนเป็นภาษาง่าย บอกว่า "ต้องทำอะไร" ไม่เกิน 3 บรรทัด/ใบ — วางไว้เหนือ footer:

```json
{ "type": "box", "layout": "vertical", "backgroundColor": "#FBF7EE", "cornerRadius": "8px",
  "paddingAll": "12px", "margin": "xl", "spacing": "sm", "contents": [
  { "type": "text", "text": "ข้อควรรู้", "size": "xs", "color": "#C9A86A", "weight": "bold" },
  { "type": "text", "text": "· <กฎข้อ 1>", "size": "xs", "color": "#1A1A1A", "wrap": true },
  { "type": "text", "text": "· <กฎข้อ 2>", "size": "xs", "color": "#1A1A1A", "wrap": true }
]}
```

**การจับคู่กฎ → step** (จาก rental-terms จริง):

| ใบ | กฎที่ remind (ภาษาง่าย) |
|---|---|
| #1 จองสำเร็จ | · โอนภายใน 30 นาที คิวถึงจะล็อก · เปลี่ยนใจ ≥7 วันก่อนวันใช้ คืนเต็มเป็นเครดิต · วันแรกของการเช่า = วันที่ชุดถึงมือ (วันขนส่งขาไปไม่นับ) |
| #2 รับยอดแล้ว | · วันแรกของการเช่า = วันที่ชุดถึงมือ · ยกเลิกก่อนส่งชุด คืน 50% เป็นเครดิต |
| #6 จัดส่งแล้ว | · เก็บถุง + ใบปะหน้าขากลับไว้ใช้ตอนคืน · รับชุดแล้วเจอตำหนิ ถ่ายรูปแจ้งในแชตทันที |
| #8 เตือนคืน | · **ห้ามซัก รีด หรือซ่อมเอง** — ส่งคืนตามสภาพ เราดูแลเองค่ะ · วันคืน = วันที่ชุดถึงร้าน เผื่อเวลาขนส่งด้วยนะคะ |
| #10 เลยกำหนด | · ค่าปรับ = ค่าเช่า 1 วัน × จำนวนวันที่เกิน · เกิน 7 วันเข้าเกณฑ์ชุดสูญหาย |
| #12 แจ้งค่าดูแล | · เราแจ้งผลใน 24 ชม. พร้อมรูปถ่ายทุกจุด · ไม่เห็นด้วยโต้แย้งได้เลยค่ะ · ส่วนที่เกินมัดจำ ชำระภายใน 7 วัน |
| #11 รับคืน+รีวิว | · มัดจำคืนเต็มเมื่อสภาพผ่าน (ถ้ามีหักจะแจ้งพร้อมหลักฐานก่อนเสมอ) |
| #14 ยกเลิก/เลื่อน | · ≥7 วันก่อนวันใช้: คืน 100% เครดิต หรือ 70% เงินสด · <7 วัน (ยังไม่ส่งชุด): คืน 50% เครดิต · ส่งชุดแล้ว: ไม่คืนค่าเช่า มัดจำคืนตามปกติ |

ใบอื่น (วันเกิด, เครดิต, ลุค, กลุ่ม ฯลฯ) **ไม่ต้องใส่กล่องกฎ** — ไม่มีภาระผูกพันใหม่ อย่าเพิ่มตัวหนังสือโดยไม่จำเป็น · ทุกกล่องปิดท้ายด้วยลิงก์ "อ่านเงื่อนไขเต็ม" ได้ที่ `rental-terms.html` เมื่อเหมาะสม
